...
We need two things "Counts" and "MetaData" (what DESeq calls colData - as it describes tge columns in Counts).
...
We can use a starting point log2FC of +2/-2 and a adjusted P-value of 0.05.
